...
(0, resource_1.default)(router, {
    index: conversationController_1.default.listCompanyConversations,
    show: conversationController_1.default.showCompanyConversation,
    store: conversationController_1.default.storeCompanyMessage
});
router.post("/:id/attachments", (0, asyncHandler_1.default)(conversationController_1.default.storeCompanyAttachment));
